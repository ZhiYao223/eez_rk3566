...
static void event_handler_cb_sample_setting_page_obj12(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_communicate_setting_page_obj18(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_motor_test_setting_page_obj24(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
void create_screen_sample_setting_page() {
    ...
    lv_obj_add_event_cb(obj, event_handler_cb_sample_setting_page_sample_setting_page, LV_EVENT_ALL, flowState);
    {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 175, 73);
            lv_obj_add_event_cb(obj, event_handler_cb_sample_setting_page_obj12, LV_EVENT_ALL, flowState);
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff009ea2), LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff0ddfcd), LV_PART_MAIN | LV_STATE_PRESSED);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_size(obj, 90, 72);
                    lv_obj_add_event_cb(obj, event_handler_cb_communicate_setting_page_obj18, LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffc9e7ff), LV_PART_MAIN | LV_STATE_PRESSED);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_color(obj, lv_color_hex(0xff0ddfcd), LV_PART_MAIN | LV_STATE_PRESSED);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_pos(obj, 19, 27);
                    lv_obj_set_size(obj, 71, 72);
                    lv_obj_add_event_cb(obj, event_handler_cb_motor_test_setting_page_obj24, LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffc9e7ff), LV_PART_MAIN | LV_STATE_PRESSED);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
...
static const char *object_names[] = { "main_page", "shift_setting_page", "sample_setting_page", "communicate_setting_page", "motor_test_setting_page", "warning_page", "setting8", "obj0", "btn_save_shift_setting", "obj1", "obj2", "obj3", "obj4", "obj5", "obj6", "obj7", "obj8", "obj9", "obj10", "motor_ccw_seconds", "motor_cw_seconds", "motor_stop_seconds", "btn_save_sample_setting", "obj11", "obj12", "obj13", "obj14", "obj15", "obj16", "obj17", "obj18", "input_address", "input_gateway", "input_dns", "btn_save_communicate_setting", "obj19", "obj20", "obj21", "obj22", "obj23", "obj24", "btn_sample_motor_cw", "btn_sample_motor_ccw", "btn_rotate_motor_ccw", "btn_rotate_motor_cw", "input_rotational_speed", "btn_save_motor_test_setting", "btn_warning_ok", "main1", "obj25", "information", "obj26", "obj27", "temperature", "obj28", "obj29", "time_h", "date_y", "time_m", "obj30", "obj31", "obj32", "date_m", "date_d", "btn_factory_reset", "barrel_1", "obj33", "barrel_2", "obj34", "barrel_3", "obj35", "main_label", "title_2", "button_left_shift", "input_main_shift", "obj36", "obj37", "obj38", "obj39", "obj40", "input_start_time1", "input_start_time2", "input_stop_time3", "input_start_time3", "input_stop_time2", "input_stop_time1", "input_auto_sample_time", "keyboard_auto", "title_4", "button_left_auto", "input_auto_ssampling_", "btn_manual_take_ccw", "btn_manual_take_cw", "obj41", "keyboard_sample", "obj42", "title_3", "button_left_communication", "input_main_communication", "keyboard_communication", "title_1", "button_left_test", "input_main_test", "keyboard_test", "title_5", "obj43" };

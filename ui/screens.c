    ...
    (void)flowState;
    {
        if (!(lv_obj_get_state(objects.input_start_time1) & LV_STATE_EDITED)) {
            ...
            if (new_val != cur_val) {
                ...
                lv_dropdown_set_selected(objects.input_start_time1, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    {
        if (!(lv_obj_get_state(objects.input_start_time2) & LV_STATE_EDITED)) {
            ...
            if (new_val != cur_val) {
                ...
                lv_dropdown_set_selected(objects.input_start_time2, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    {
        if (!(lv_obj_get_state(objects.input_stop_time3) & LV_STATE_EDITED)) {
            ...
            if (new_val != cur_val) {
                ...
                lv_dropdown_set_selected(objects.input_stop_time3, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    {
        if (!(lv_obj_get_state(objects.input_start_time3) & LV_STATE_EDITED)) {
            ...
            if (new_val != cur_val) {
                ...
                lv_dropdown_set_selected(objects.input_start_time3, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    ...
    }
    {
        if (!(lv_obj_get_state(objects.input_stop_time1) & LV_STATE_EDITED)) {
            ...
            if (new_val != cur_val) {
                ...
                lv_dropdown_set_selected(objects.input_stop_time1, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    {
        if (!(lv_obj_get_state(objects.input_sample_times3) & LV_STATE_EDITED)) {
            ...
            if (new_val != cur_val) {
                ...
                lv_dropdown_set_selected(objects.input_sample_times3, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    {
        if (!(lv_obj_get_state(objects.input_sample_times2) & LV_STATE_EDITED)) {
            ...
            if (new_val != cur_val) {
                ...
                lv_dropdown_set_selected(objects.input_sample_times2, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    {
        if (!(lv_obj_get_state(objects.input_sample_times1) & LV_STATE_EDITED)) {
            ...
            if (new_val != cur_val) {
                ...
                lv_dropdown_set_selected(objects.input_sample_times1, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
